...
<template>
  <footer class="relative bg-[#0a0908] border-t border-[rgba(200,146,42,0.15)]">
    <div class="max-w-7xl mx-auto px-6 py-12">
      ...
      <!-- Bottom bar -->
      <div class="mt-8 pt-6 border-t border-[rgba(200,146,42,0.08)] flex flex-col sm:flex-row items-center justify-between gap-3">
        <p class="font-body text-xs text-[#a89880]/60">
          © {{ year }} Ginger Bistro. Todos los derechos reservados.
        </p>
        <p class="font-body text-xs text-[#a89880]/40 italic">
          Bistronomia · Pamplona, Norte de Santander
        </p>
      </div>
    </div>
  </footer>
